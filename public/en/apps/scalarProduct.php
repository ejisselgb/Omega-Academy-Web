...
<html lang="en">
  <head>
    ...
    <title>Scalar Product | Omega Academy</title>
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="container-fluid">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><a href="../../es/apps/productoEscalar.php" style="color: white">Español</a></li>              
              <li class="active2"><a href="scalarProduct.php" style="color: #d40b3a">English</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div><!--/.container-fluid -->
      </div>                
      ...
      <form method="POST" action="scalarProduct.php" class="form-inline text-center" role="form">
        <legend><h2>Scalar Product</h2></legend>        
        <div class="form-group">          
          <input name="escalar" type="text" class="form-control" id="escalar" placeholder="Number" <?php 
            if (isset($_POST["escalar"])) {
              echo "value=".$_POST["escalar"];
            }
          ?> required autofocus>
        </div>
        <br><br>
...
if (isset($_POST["filas1"]) && isset($_POST["columnas1"]) && isset($_POST["escalar"]) ) {
...
?>
      ...
      <div class="text-center">        
        <?php 
          if (isset($_POST["filas1"])) {            
            echo '<br><br>
                  <button class="btn btn-primary" onclick="escalar()">Scalar Product</button>
    ...
    <script src="../../js/matrices/escalar.js"></script>
  </body>
</html>
