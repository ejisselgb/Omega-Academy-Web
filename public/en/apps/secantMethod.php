...
<html lang="en">
  <head>
    ...
    <title>Secant Method | Omega Academy</title>
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="container-fluid">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><a href="../../es/apps/metodoSecante.php" style="color: white">Español</a></li>              
              <li class="active2"><a href="secantMethod.php" style="color: #d40b3a">English</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div><!--/.container-fluid -->
      </div>          
      
      <form class="form-horizontal" method="POST" action="secantMethod.php" role="form">
        <legend><h2 class="text-center">Secant Method</h2></legend>
        ...
        <div class="form-group">
          <label class="col-sm-5 control-label" for="x0">Point x0 = </label>
          <div class="col-sm-3">
        ...
        <div class="form-group">
          <label class="col-sm-5 control-label" for="x1">Point x1 = </label>
          <div class="col-sm-3">
        ...
        <div class="form-group">
          <label class="col-sm-5 control-label" for="error">Relative Error = </label>
          <div class="col-sm-3">
        ...
        <div class="text-center">
          ...
          <a href="secantMehod.php" class="btn btn-danger">DELETE</a>
        </div>
      </form>
      ...
      <table class="table table-bordered table-hover">
        <thead>
          <tr>
            ...
            <th class="text-center">Point xn</th>
            <th class="text-center">Relative Error xi</th>
          </tr>
        </thead>
        <tbody>
      ...
      <div style="text-align: center;">
        <a id="boton" href="http://www.youtube.com/watch?v=GKwzBrzsPSU" target="_blank" type="button" class="btn btn-lg" style="background: gray; color: white">Video</a>
        <a id="boton" href="../documents/unit7.pdf" target="_blank" type="button" class="btn btn-lg" style="background: #D40B3A; color: white">Document</a>        
      </div>
