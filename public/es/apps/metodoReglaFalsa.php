...
<html lang="es">
  <head>
    ...
    <title>Método de Regla Falsa | Omega Academy</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-horizontal" method="POST" action="metodoReglaFalsa.php" role="form">        
        <legend><h2 class="text-center">Método de Regla Falsa</h2></legend>
...
?>          
      ...
      <div style="text-align: center;">
        <a id="boton" href="http://www.youtube.com/watch?v=A-3YQgMV6NM" target="_blank" type="button" class="btn btn-lg" style="background: gray; color: white">Vídeo</a>
        <a id="boton" href="../documentos/unidad5.pdf" target="_blank" type="button" class="btn btn-lg" style="background: #D40B3A; color: white">Documento</a>        
      </div>
