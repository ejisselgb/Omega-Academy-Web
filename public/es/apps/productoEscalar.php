...
<html lang="es">
  <head>
    ...
    <title>Producto por un escalar | Omega Academy</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <form method="POST" action="productoEscalar.php" class="form-inline text-center" role="form">
        <legend><h2>Producto por un escalar</h2></legend>        
        <div class="form-group">          
          <input name="escalar" type="text" class="form-control" id="escalar" placeholder="Escalar" <?php 
...
?>
      ...
      <div class="text-center">        
        <?php 
          if (isset($_POST["filas1"])) {            
            echo '<br><br>
                  <button class="btn btn-primary" onclick="escalar()">Multiplicar por escalar</button>
