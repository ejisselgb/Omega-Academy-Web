...
<html lang="es">
  <head>
    ...
    <title>Transpuesta de una Matriz | Omega Academy</title>
        ...
        <div class="container-fluid">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="active2"><a href="transpuesta.php" style="color: #d40b3a">Español</a></li>              
              <li><a href="../../en/apps/transpose.php" style="color: white">English</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div><!--/.container-fluid -->
      </div>                
    
      <form method="POST" action="transpuesta.php" class="form-inline text-center" role="form">
        <legend><h2>Transpuesta de una Matriz</h2></legend>
...
?>
      ...
      <div class="text-center">        
        <?php 
          if (isset($_POST["filas"]) && isset($_POST["columnas"])) {            
            echo '<br><br>
                  <button class="btn btn-primary" onclick="transpuesta()">Transpuesta</button>
