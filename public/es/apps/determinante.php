...
<html lang="es">
  <head>
    ...
    <title>Determinante de una Matriz | Omega Academy</title>
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="container-fluid">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="active2"><a href="determinante.php" style="color: #d40b3a">Español</a></li>              
              <li><a href="../../en/apps/determinant.php" style="color: white">English</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div><!--/.container-fluid -->
      </div>                
      ...
      <form method="POST" action="determinante.php" class="form-inline text-center" role="form">
        <legend><h2>Determinante de una Matriz</h2></legend>        
        <h4>Matriz 1</h4>
...
?>
    ...
    <script src="../../js/matrices/determinante.js"></script>
  </body>
</html>