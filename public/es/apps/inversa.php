...
<html lang="es">
  <head>
    ...
    <title>Inversa de una Matriz | Omega Academy</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <form method="POST" action="inversa.php" class="form-inline text-center" role="form">
        <legend><h2>Inversa de una Matriz</h2></legend>        
        <h4>Matriz 1</h4>
        ...
        <div class="form-group">          
          <input name="columnas1" type="text" class="form-control" id="columnas1" placeholder="Número de columnas" <?php 
...
?>
      ...
      <div class="text-center">        
        <?php 
          if (isset($_POST["filas1"])) {            
            echo '<br><br>
                  <button class="btn btn-primary" onclick="inversa()">Calcular Inversa</button>
