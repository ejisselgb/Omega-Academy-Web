  ...
  <body>
    ...
    <div class="container">
      ...
      <div style="text-align: center;">
        <a id="boton" href="http://www.youtube.com/watch?v=Of8bVGmAnYQ" target="_blank" type="button" class="btn btn-lg" style="background: gray; color: white">Vídeo</a>
        <a id="boton" href="../documentos/unidad6.pdf" target="_blank" type="button" class="btn btn-lg" style="background: #D40B3A; color: white">Documento</a>
      </div>
