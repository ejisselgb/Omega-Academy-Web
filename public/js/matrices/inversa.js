...
function inversa() {
	if (validarMatriz1()) {
		...
		var resultado = matrix_invert(matriz1);

		if (typeof resultado === "undefined") {
			alert("La matriz que ingreso no tiene inversa");
		}

		var cont = 0;
		for (var i = 0; i < filas1; i++) {
			for (var j = 0; j < columnas1; j++) {
				document.getElementById('c'+cont).value = resultado[i][j];
				cont++;
			}
		}
